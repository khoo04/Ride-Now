...
class CreateRideSuccessScreen extends StatelessWidget {
  static const routeName = '/create-ride/success';
  const CreateRideSuccessScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocBuilder<RideCreateBloc, RideCreateState>(
          builder: (context, state) {
            if (state is! RideCreateSuccess) {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            "Success! Your ride has been created!",
                            style: TextStyle(
